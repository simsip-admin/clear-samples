...
[assembly:ExportRenderer(typeof(Simsip.Demo.Pages.CameraPage), typeof(Simsip.Demo.Droid.Pages.CameraPage))]
namespace Simsip.Demo.Droid.Pages
{
	/*
	...
	public class CameraPage : PageRenderer, TextureView.ISurfaceTextureListener
	{
		...
		private async void TakePhotoButtonTapped (object sender, EventArgs e)
		{
			...
			var navigationPage = new NavigationPage (new DrawMomentPage (imageBytes)) {
				BarBackgroundColor = Xamarin.Forms.Color.FromHex("4A90E2"),
