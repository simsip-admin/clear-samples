...
{
    public class FlashPassPage : ContentPage
    {
        public FlashPassPage ()
        {
            BackgroundColor = Color.White;

            var backgroundImage = new Image () {
                Source = new FileImageSource () { File = "six_flags_park.jpg" },
            ...
            var face = new Image () {
                Aspect = Aspect.AspectFill,
                Source = new FileImageSource () { File = "logo2.png" }
            };
            ...
            var details = new FlashPassDetailsView ();
            ...
            // var slideshow = new MainSlideShowView ();
