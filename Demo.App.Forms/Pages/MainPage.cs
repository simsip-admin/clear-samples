    ...
    public class MainPage : ContentPage
	{
		public MainPage ()
		{
			...
			var backgroundImage = new Image () {
				Source = new FileImageSource () { File = "six_flags_logo.png" },
            ...
            tapGestureRecognizerCamera.Tapped += (s, e) =>
            {
                Navigation.PushAsync(new CameraPage());
            };
            face.GestureRecognizers.Add(tapGestureRecognizerCamera);
			...
			var details = new MainDetailsView ();
