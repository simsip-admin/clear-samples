...
[assembly: ExportRenderer(typeof(LoginPage), typeof(Models.iOS.Renderers.LoginPageRenderer))]

namespace Models.iOS.Renderers
{
    public class LoginPageRenderer : PageRenderer
    {
        ...
        public override void ViewDidAppear(bool animated)
        {
            ...
            if (!IsShown)
            {
                ...
                {
                    // For ios8 and facebook add this line:
                    // DismissViewController (true, null);
                    // Reference:
                    // http://stackoverflow.com/questions/24105390/how-to-login-to-facebook-in-xamarin-forms
